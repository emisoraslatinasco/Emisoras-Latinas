...
export type CountryCode = 'CO' | 'PE' | 'BR' | 'EC' | 'MX' | 'GT' | 'BO' | 'SV' | 'JM' | 'PR' | 'DO' | 'UA' | 'UY';
...
export const countries: Country[] = [
  ...
  { code: 'PR', name: 'Puerto Rico', flag: '/flags/puerto rico.png', jsonFile: 'emisoras_puertorico.json' },
  { code: 'DO', name: 'República Dominicana', flag: '/flags/Republica dominicana.png', jsonFile: 'emisoras_republica_dominicana.json' },
  { code: 'UA', name: 'Ucrania', flag: '/flags/Ucrania.jpg', jsonFile: 'emisoras_ukrania.json' },
