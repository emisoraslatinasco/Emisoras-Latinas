...
export default function DynamicHeader({ selectedCountry, stationCount }: DynamicHeaderProps) {
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className={`absolute inset-0 bg-gradient-to-r ${theme.gradient} opacity-10 animate-gradient-rotate`}></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="relative flex-shrink-0">
            <div className={`absolute -inset-1 bg-gradient-to-r ${theme.gradient} rounded-xl blur opacity-60 animate-pulse`}></div>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              ...
              <h1 className={`text-xl md:text-2xl font-bold bg-gradient-to-r ${theme.gradient} bg-clip-text text-transparent truncate`}>
                Emisoras de {countryName}
              </h1>
            </div>
            <p className={`text-sm ${theme.accentColor} font-medium truncate hidden sm:block`}>
              {theme.slogan}
            </p>
          </div>
