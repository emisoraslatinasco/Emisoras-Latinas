...
export async function generateMetadata({ params }: { params: Promise<{ country: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `/radio/${resolvedParams.country}/privacidad`,
      languages: {
        [getHreflangFromCountry(resolvedParams.country)]: `/radio/${resolvedParams.country}/privacidad`,
      },
    },
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: isSpanish ? "Política de Privacidad" : isPortuguese ? "Política de Privacidade" : "Privacy Policy", url: `https://www.emisoraslatinas.online/radio/${resolvedParams.country}/privacidad` },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <nav className="text-sm text-slate-500 mb-8 flex items-center gap-2">
          ...
          <i className="fas fa-chevron-right text-xs"></i>
          <span className="text-white">{isSpanish ? "Política de Privacidad" : isPortuguese ? "Política de Privacidade" : "Privacy Policy"}</span>
        </nav>
